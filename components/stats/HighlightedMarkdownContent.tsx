...
export default function HighlightedMarkdownContent({
  ...
  return (
    <Typography.Prose className="max-w-none wrap-break-word text-sm leading-6 [&_a]:text-accent [&_a]:underline [&_a]:underline-offset-4 [&_blockquote]:border-l-2 [&_blockquote]:border-accent/60 [&_blockquote]:pl-3 [&_blockquote]:text-muted [&_code:not(.hljs)]:rounded-md [&_code:not(.hljs)]:bg-default-soft [&_code:not(.hljs)]:px-1.5 [&_code:not(.hljs)]:py-0.5 [&_code:not(.hljs)]:text-[0.8125rem] [&_del]:text-muted [&_del]:decoration-2 [&_details]:my-5 [&_details]:rounded-lg [&_details]:border [&_details]:bg-default-soft/40 [&_details]:px-4 [&_details]:py-3 [&_h1]:mb-5 [&_h1]:mt-12 [&_h1]:scroll-mt-24 [&_h1:first-child]:mt-0 [&_h2]:mb-4 [&_h2]:mt-10 [&_h2]:scroll-mt-24 [&_h2:first-child]:mt-0 [&_h3]:mb-3 [&_h3]:mt-8 [&_h3]:scroll-mt-24 [&_h3:first-child]:mt-0 [&_h4]:mb-3 [&_h4]:mt-7 [&_h4]:scroll-mt-24 [&_h4:first-child]:mt-0 [&_h5]:mb-2 [&_h5]:mt-6 [&_h5]:scroll-mt-24 [&_h5:first-child]:mt-0 [&_h6]:mb-2 [&_h6]:mt-5 [&_h6]:scroll-mt-24 [&_h6:first-child]:mt-0 [&_ol]:list-decimal [&_ol]:pl-5 [&_pre]:my-4 [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre_code]:min-w-max [&_summary]:cursor-pointer [&_summary]:font-semibold [&_u]:decoration-2 [&_u]:underline-offset-4 [&_ul]:list-disc [&_ul]:pl-5">
      <ReactMarkdown
        remarkPlugins={[
          remarkGfmTables,
          remarkSafeHtml,

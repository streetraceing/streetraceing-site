...
export const translations = {
  ru: {
    ...
    tempChat: {
      ...
      titlePlaceholder: 'Например: Обмен файлами по проекту',
      ttlLabel: 'Чат удалится через',
      ttlOptions: {
        1: '1 час',
        6: '6 часов',
        24: '24 часа',
      ...
      passwordHint: 'Его спросят при входе по ссылке.',
      create: 'Создать чат',
      creating: 'Создаю…',
      createFailed: 'Не удалось создать чат. Попробуй ещё раз.',
      titleRequired: 'Добавь название чата (до 80 символов).',
      passwordTooLong: 'Пароль не длиннее 200 символов.',
      invalidTtl: 'Выбери срок жизни чата.',
      createRateLimited: 'Слишком много чатов за раз. Попробуй позже.',
      gateTitle: 'Вступить в чат',
      gateDescription: 'Как тебя покажет другим участникам?',
      nameLabel: 'Твоё имя',
      namePlaceholder: 'Например: Андрей',
      nameRequired: 'Введи имя (до 40 символов).',
      gatePasswordLabel: 'Пароль чата',
      sessionExpired: 'Сессия истекла - войди заново.',
      invalidRequest: 'Некорректный запрос.',
      invalidMessage: 'Сообщение пустое.',
      join: 'Войти',
      joining: 'Вхожу…',
      joinFailed: 'Не удалось войти. Попробуй ещё раз.',
      invalidPassword: 'Неверный пароль чата.',
      expired: 'Этот чат уже удалён.',
      roomNotFound: 'Чат не найден.',
      ...
      messageTooLong: 'Сообщение длиннее 20 000 символов.',
      ...
      save: 'Сохранить',
      attachmentsLimit: 'Не больше 10 файлов на сообщение.',
      uploadingFiles: 'Загружаю файлы {done} из {total}…',
      mediaTitle: 'Медиа',
    ...
    tools: {
      ...
      baseConverter: {
        label: 'Число',
        placeholder: 'Например: 255, ff или 1010',
        description:
          'Основание ввода определяет, как читать число. Пробелы и подчёркивания игнорируются, большие значения поддерживаются через BigInt.',
        inputBase: 'Основание ввода',
        invalid:
          'В числе есть символы, которые не подходят выбранному основанию.',
        errorTitle: 'Некорректное число',
        output: 'Представления числа',
        binary: 'Двоичное (BIN)',
        octal: 'Восьмеричное (OCT)',
        decimal: 'Десятичное (DEC)',
        hexadecimal: 'Шестнадцатеричное (HEX)',
      },
      colorConverter: {
        label: 'HEX-цвет',
        hexHint: 'HEX в формате #RRGGBB или #RGB.',
        ...
        invalid: 'Проверь HEX-значение.',
        errorTitle: 'Некорректный цвет',
        output: 'Форматы цвета',
        hex: 'HEX',
        rgbCss: 'CSS rgb()',
        hslCss: 'CSS hsl()',
      },
      urlCodec: {
        label: 'Текст или процентное кодирование',
        placeholder: 'https://example.com/search?q=привет мир',
        description:
          'Кодирование выполняется для компонента ссылки: пробелы, кириллица и спецсимволы превращаются в %XX-последовательности.',
        encode: 'Закодировать',
        decode: 'Декодировать',
        example: 'Пример',
        invalidDecode:
      ...
      slug: {
        label: 'Текст',
        placeholder: 'Например: Мои заметки: дизайн и код',
        description:
          'Кириллица транслитерируется, регистр становится нижним, лишние символы заменяются разделителем.',
        separator: 'Разделитель',
        separatorDash: 'Дефис',
        separatorUnderscore: 'Подчёркивание',
        example: 'Пример',
        output: 'Slug',
      },
      hmac: {
  ...
  en: {
    ...
    tempChat: {
      titleLabel: 'Chat name',
      titlePlaceholder: 'For example: Project file swap',
      ttlLabel: 'The chat will be deleted in',
      ttlOptions: {
        1: '1 hour',
        6: '6 hours',
        24: '24 hours',
      ...
      passwordHint: 'It will be asked when joining through the link.',
      create: 'Create chat',
      creating: 'Creating…',
      createFailed: 'Could not create the chat. Try again.',
      titleRequired: 'Add a chat name (up to 80 characters).',
      passwordTooLong: 'The password is longer than 200 characters.',
      invalidTtl: 'Pick the chat lifetime.',
      createRateLimited: 'Too many chats at once. Try again later.',
      gateTitle: 'Join the chat',
      gateDescription: 'How should other members see you?',
      nameLabel: 'Your name',
      namePlaceholder: 'For example: Andrey',
      nameRequired: 'Enter your name (up to 40 characters).',
      gatePasswordLabel: 'Chat password',
      sessionExpired: 'Your session expired - join again.',
      invalidRequest: 'Invalid request.',
      invalidMessage: 'The message is empty.',
      join: 'Join',
      joining: 'Joining…',
      joinFailed: 'Could not join. Try again.',
      invalidPassword: 'Wrong chat password.',
      expired: 'This chat has already been deleted.',
      roomNotFound: 'Chat not found.',
      ...
      messageTooLong: 'The message is longer than 20,000 characters.',
      ...
      save: 'Save',
      attachmentsLimit: 'Up to 10 files per message.',
      uploadingFiles: 'Uploading files {done} of {total}…',
      mediaTitle: 'Media',
    ...
    tools: {
      ...
      baseConverter: {
        label: 'Number',
        placeholder: 'For example: 255, ff, or 1010',
        description:
          'The input base defines how the number is read. Spaces and underscores are ignored; large values are supported through BigInt.',
        inputBase: 'Input base',
        invalid:
          'The number contains characters that do not fit the selected base.',
        errorTitle: 'Invalid number',
        output: 'Number representations',
        binary: 'Binary (BIN)',
        octal: 'Octal (OCT)',
        decimal: 'Decimal (DEC)',
      ...
      urlCodec: {
        label: 'Text or percent-encoded value',
        placeholder: 'https://example.com/search?q=hello world',
        description:
          'Encoding applies to a link component: spaces, non-ASCII letters, and special characters become %XX sequences.',
        encode: 'Encode',
        decode: 'Decode',
        example: 'Example',
      ...
      slug: {
        label: 'Text',
        placeholder: 'For example: My notes on design and code',
        description:
          'Cyrillic letters are transliterated, the text is lowercased, and extra characters are replaced with the separator.',
        separator: 'Separator',
